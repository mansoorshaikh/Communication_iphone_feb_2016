...
@synthesize markedDates,markedColors,calendarHeight,selectedDate,activityDetailsArray,appDelegate;
...
- (void)drawRect:(CGRect)rect
{
    ...
    //Arrow right
    CGContextBeginPath(context);
    CGContextMoveToPoint(context, self.frame.size.width-(zmargin+arrowSize/1.5), ymargin);
    CGContextAddLineToPoint(context,self.frame.size.width-zmargin,ymargin+arrowSize/2);
    CGContextAddLineToPoint(context,self.frame.size.width-(zmargin+arrowSize/1.5),ymargin+arrowSize);
    CGContextAddLineToPoint(context,self.frame.size.width-(zmargin+arrowSize/1.5), ymargin);
    ...
    //Grid dark lines
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithHexString:@"0x383838"].CGColor);
    CGContextBeginPath(context);
